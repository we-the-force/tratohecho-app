...
import { Page, Navbar, BlockTitle, Block, Messagebar, Messages,Message, MessagesTitle, Link, MessagebarAttachments, MessagebarSheetImage, MessagebarSheet} from 'framework7-react';
...
export default class extends React.Component {
  ...
  render() {
    return (
      <Page hideToolbarOnScroll noToolbar>
        <Navbar title="Messages" backLink="Regresar"></Navbar>
